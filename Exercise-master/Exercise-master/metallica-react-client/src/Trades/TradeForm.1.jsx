...
const AddTrade = gql`
            mutation addTrade($trade:TradeType!) {
...
const AddTradeToList = graphql(AddTrade)(TradeForm);

export default withRouter(AddTradeToList);